...
INK_MID          = (61,  74,  54)
INK_SOFT         = (107, 122, 98)
TERRACOTTA       = (139, 58,  26)
LAPIS            = (26,  52,  104)
GOLD             = (160, 120, 48)
CREAM_BOX        = (246, 241, 221)
...
SCHEMES = {
    "main": dict(
        bg        = TYRIAN_PURPLE,
        col_label = GOLD,                           # #A07830
        col_title = PAPER,                          # #F6F1DB
        col_sub   = "#D8B8C8",                    # dusty pale mauve
        col_dom   = "#B47A98",                    # quieter mauve for URL
    ),    
    "library": dict(
        bg        = TERRACOTTA,
        col_label = GOLD,
        ...
        col_dom   = _blend(PAPER, 0.40, TERRACOTTA),
    ),
    "archives": dict(
        bg        = LAPIS,
        col_label = GOLD,
        ...
        col_dom   = _blend(PAPER, 0.40, LAPIS),
    ),
}
...
PAGES = [
    dict(file="index.html", slug="og-pm-main", section="main",
         ...
         title="Per Medjat", subtitle="House of Written Knowledge",
    ...
    dict(file="library/index.html", slug="og-pm-library", section="library",
         ...
         subtitle="Cataloged scholarly and reference materials for Afro-Atlantic research",
    ...
    dict(file="archives/index.html", slug="og-pm-archives", section="archives",
         ...
         subtitle="Primary source and governed collections under the Iroko Framework",
    ...
    dict(file="ewe/index.html", slug="og-pm-ewe", section="archives",
         ...
         title="Ewe Database",
         subtitle="Botanical knowledge structured under the Iroko Framework",
    ...
    dict(file="entrusting/index.html", slug="og-pm-entrusting", section="archives",
         ...
         subtitle="Knowledge donations, collection transfers, and stewardship agreements",
    ...
    dict(file="espiritismo/index.html", slug="og-pm-espiritismo", section="archives",
         ...
         subtitle="Caribbean Spiritism archival and ethnographic materials",
    ...
    dict(file="hyatt/index.html", slug="og-pm-hyatt", section="archives",
         ...
         subtitle="Hoodoo and rootwork materials under the Iroko Framework",
...
def make_og_image(page: dict) -> Image.Image:
    ...
    dw     = _text_w(draw, domain, f_dom)
    dh     = _text_h(draw, domain, f_dom)
    draw.text(((W - dw) // 2, H - 42 - dh), domain, font=f_dom, fill=sc["col_dom"])
    return img
