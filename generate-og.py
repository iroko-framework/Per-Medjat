...
LEXICON_INDIGO = (52, 48, 94)      # #34305E, the Lexicon accent (adire indigo)
...
SCHEMES = {
    ...
    "lexicon": dict(
        ...
        col_label = GOLD_LABEL,
        col_title = PAPER,
        col_sub   = _blend(PAPER, 0.75, LEXICON_INDIGO),
        col_dom   = _blend(PAPER, 0.55, LEXICON_INDIGO),
    ),
}
...
PAGES = [
    ...
    dict(file="archives/first-response/index.html", slug="og-pm-first-response", section="archives",
         label="MEDJAT ARCHIVES · COLLECTION CARE",
         title="Before Anything Is Moved",
         subtitle="A first-response guide for an\nat-risk community collection",
         og_title="Before Anything Is Moved - Medjat Archives",
         og_description="A first-response guide for families, congregations, and community organizations caring for an at-risk collection during an urgent move, closure, or change of caretaker.",
         og_url=f"{BASE_URL}/archives/first-response/"),
    ...
    dict(file="research-portals/index.html", slug="og-pm-research-portals", section="portals",
         ...
         og_description="Curated Afro-Atlantic research portals for archives, thesis repositories, digital collections, finding aids, and databases, with language and access notes.",
         og_url=f"{BASE_URL}/research-portals/"),
    # lexicon/index.html is generated by medjat-tools/medjat_lexicon; its template carries the same tags,
    # so a rebuild keeps them. Change the copy in both places.
    dict(file="lexicon/index.html", slug="og-pm-lexicon", section="lexicon",
         label="PER MEDJAT · MEDJAT LEXICON",
         title="Medjat Lexicon",
         subtitle="Afro-Atlantic dictionaries,\nsearched together",
         og_title="Medjat Lexicon - Per Medjat - Iroko Historical Society",
         og_description="Look up a word across historical and modern dictionaries of Yorùbá, Lucumí, Kikongo, Cuban Kongo, Kimbundu, Twi and Brazilian Portuguese, with or without diacritics. Every entry names its source and links to the printed page.",
         og_url=f"{BASE_URL}/lexicon/"),
]
